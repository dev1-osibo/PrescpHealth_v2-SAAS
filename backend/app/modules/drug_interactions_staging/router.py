...
from app.modules.drug_interactions_staging.engine import InteractionEngine
from app.modules.drug_interactions_staging.schemas import (
...
async def get_active_medications(
    ...
    from app.modules.drug_interactions_staging.models import MedicationRecord
