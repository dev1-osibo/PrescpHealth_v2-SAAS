...
Follows alerts_staging/tasks.py patterns:
...
async def _generate_clinical_pdf_async(
    ...
    """
    from app.modules.reports_staging.pdf_builder import PDFBuilder
...
async def _update_task_status(
    ...
    try:
        ...
        logger.warning(
            ...
            status=status,
            error_type=type(exc).__name__,
            note="tasks_tracker_staging not available; status update is a no-op",
        )
