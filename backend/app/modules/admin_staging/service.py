...
from app.modules.admin_staging.schemas import TenantSettingsRequest
from app.modules.admin_staging.service_model import ModelManagementService
...
class AdminService:
    ...
    async def update_tenant_settings(self, data: TenantSettingsRequest) -> dict[str, Any]:
        ...
        """
        from app.modules.admin_staging.schemas import UpdateTenantRequest
